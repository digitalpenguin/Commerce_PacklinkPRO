...
if (!createObject('modNamespace',array(
    'name' => 'commerce_packlinkpro',
    'path' => $componentPath.'/core/components/commerce_packlinkpro/',
    'assets_path' => $componentPath.'/assets/components/commerce_packlinkpro/',
),'name', false)) {
    echo "Error creating namespace commerce_packlinkpro.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_packlinkpro.core_path',
    'value' => $componentPath.'/core/components/commerce_packlinkpro/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_packlinkpro',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_packlinkpro.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_packlinkpro.assets_path',
    'value' => $componentPath.'/assets/components/commerce_packlinkpro/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_packlinkpro',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_packlinkpro.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_packlinkpro/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_packlinkpro.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_packlinkpro',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_packlinkpro.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        ...
        echo "Error creating commerce_packlinkpro.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_packlinkpro/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_packlinkpro/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'DigitalPenguin\\Commerce_PacklinkPRO\\Modules\\', $modulePath);
